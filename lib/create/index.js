...
module.exports = function (dir, optionalId, optionalName, cfg, extEvents) {
  ...
  var questions = {
    ...
    autoInstall: {
      ...
      choices: [{ name: 'Yes, use NPM', value: 'npm', short: 'npm' }, { name: 'Yes, use Yarn', value: 'yarn', short: 'yarn' }, { name: 'No, I will handle that myself', value: false, short: 'no' }]
    }
  };

  ask(questions, cfg, function () {
