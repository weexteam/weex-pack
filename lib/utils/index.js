...
var utils = {
  ...
  exec: function exec(command, quiet, options) {
    return new Promise(function (resolve, reject) {
      try {
        var child = childProcess.exec(command, Object.assign({ encoding: 'utf8', wraning: false, maxBuffer: Infinity }, options), function (error, stdout, stderr) {
          if (error) {
